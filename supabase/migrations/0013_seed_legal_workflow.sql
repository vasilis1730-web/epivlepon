...
('S23_ENSTASEIS','f2_ektelesi',24,'Ενστάσεις — διοικητική επίλυση διαφορών',
 'Παραλαβή ένστασης εντός 15 ημερών από την κοινοποίηση της πράξης· εισήγηση και αιτιολογημένη γνώμη Τεχνικού Συμβουλίου· έκδοση ΚΑΙ κοινοποίηση της απόφασης εντός 60 ημερών από την άσκηση της ένστασης.',
 'anadochos','proistameni_arxi','conditional','N4412/174',60,null,'ypovoli_eggrafou',true,
 'Άπρακτη πάροδος 60 ημερών από την άσκηση: εξαντλείται η ενδικοφανής προδικασία και ανοίγει η δικαστική επίλυση του άρθρου 175.',null,null,
